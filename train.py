...
def setup_training_options(
    ...
    cfg_specs = {
        ...
        'endless':     dict(ref_gpus=8,  kimg=25000,  mb=32, mbstd=4,  fmaps=1,   lrate=0.0005,  gamma=10,   ema=10,  ramp=None, map=8), # uses mixed-precision, unlike original StyleGAN2
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['auto', 'endless', '11gb-gpu','11gb-gpu-complex', '24gb-gpu','24gb-gpu-complex', '48gb-gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline'])
